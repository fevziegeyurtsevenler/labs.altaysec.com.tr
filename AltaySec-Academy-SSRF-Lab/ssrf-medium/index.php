...
<head>
    ...
    <style>:root{--accent:#818cf8;--accent-glow:rgba(129,140,248,.15);}</style>
</head>
<body>
    <div class="site-shell">
        <header>
            <div class="brand-row">
                ...
                <div style="margin-left:auto;font-size:11px;font-weight:700;letter-spacing:1px;background:var(--accent);color:#000;padding:2px 8px;border-radius:4px;">ORTA</div>
            </div>
            <nav class="main-nav">
        ...
        <footer class="site-footer">
            <div style="margin-bottom:20px;">
                <details style="cursor:pointer; background:var(--surface); border:1px solid var(--border); border-radius:8px; padding:10px; max-width:400px; margin:0 auto;">
                    ...
                    <p style="font-size:12px; color:var(--text-muted); margin-top:8px;">Metin bazlı filtreler, IP adreslerinin alternatif gösterimleriyle (ondalık, sekizlik veya kısa IPv4) kolayca atlatılabilir. Host ismini değil, hedefin çözümlediği adresi düşünün.</p>
                </details>
            </div>
