...
<div class="card fetch-card">
    <h3 style="font-family:'Fraunces',serif;margin-bottom:10px;">Webhook Doğrulayıcı</h3>
    <p style="font-size:14px;color:var(--text-muted);margin-bottom:15px;">Tüm özel IP aralıkları engellenmiş durumda. Protokol seviyesinde bir açık bulabilir misiniz?</p>
...
<div class="card">
    ...
    <p>Bu seviyede tüm IP tabanlı SSRF teknikleri engellenmiştir. Hedefiniz, sunucunun dosya sisteminde bulunan <strong>/var/www/html/secret.txt</strong> dosyasını okuyarak bayrağa ulaşmaktır. Bunun için <code>file://</code> gibi tehlikeli wrapper'ları kullanmayı deneyin.</p>
</div>
...
(function(){
    ...
    async function doFetch(){
        ...
        body.textContent='Protokol bypass deneniyor...';btn.disabled=true;
        try{
