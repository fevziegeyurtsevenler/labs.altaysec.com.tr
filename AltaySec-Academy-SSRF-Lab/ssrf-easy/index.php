...
<head>
    ...
    <style>:root{--accent:#06b6d4;--accent-glow:rgba(6,182,212,.15);}</style>
</head>
<body>
    <div class="site-shell">
        <header>
            <div class="brand-row">
                ...
                <div style="margin-left:auto;font-size:11px;font-weight:700;letter-spacing:1px;background:var(--accent);color:#000;padding:2px 8px;border-radius:4px;">KOLAY</div>
            </div>
            <nav class="main-nav">
        ...
        <!-- Bu kısımda grid-template-columns: 1fr; ekleyerek kartların tam uzamasını sağlıyoruz -->
        ...
        <footer class="site-footer">
            <div style="margin-bottom:20px;">
                <details style="cursor:pointer; background:var(--surface); border:1px solid var(--border); border-radius:8px; padding:10px; max-width:400px; margin:0 auto;">
                    ...
                    <p style="font-size:12px; color:var(--text-muted); margin-top:8px;">Bu labda herhangi bir filtre bulunmamaktadır. Sunucunun kendi loopback adresini (127.0.0.1) sorgulayarak gizli servislere ulaşmayı deneyin.</p>
                </details>
            </div>
