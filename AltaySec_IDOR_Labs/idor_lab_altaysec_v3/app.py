...
tickets_db = {
    str(uuid.uuid4()):  {"name": "Admin (root)",       "type": "VIP - ORGANİZATÖR",      "seat": "A-01", "price": "PAHA BİÇİLEMEZ", "secret": "ALTAYSEC{eglenceyi_kacirma}"},
    str(uuid.uuid4()):  {"name": "Ahmet Demir",        "type": "Ekip Lideri", "seat": "A-03", "price": "ÜCRETSİZ (GÖREVLİ)", "secret": "Sunucuların yedeğini almayı unuttum..."},
    str(uuid.uuid4()):  {"name": "Ceren Arslan", "type": "Lider Yardımcısı",       "seat": "A-07", "price": "ÜCRETSİZ (BAŞKAN)", "secret": "Gelecek dönemin etkinlik planı çantamda."},
    str(uuid.uuid4()):  {"name": "Mehmet Yılmaz",   "type": "Lider Yardımcısı",  "seat": "B-01", "price": "ÜCRETSİZ", "secret": "xxx"},
    str(uuid.uuid4()):  {"name": "İrem Çetin",         "type": "Teknik Ekip",      "seat": "B-05", "price": "100 TL", "secret": "xxx"},
    str(uuid.uuid4()):  {"name": "Emre Çelik",    "type": "Adana'","seat": "B-09", "price": "100 TL", "secret": "xxx"},
    str(uuid.uuid4()):  {"name": "Buse Kaya",         "type": "Misafir",                "seat": "C-01", "price": "100 TL", "secret": "xxx"},
    str(uuid.uuid4()):  {"name": "Kerem Kılıç",    "type": "Misafir",                "seat": "C-02", "price": "100 TL", "secret": "xxx"},
    str(uuid.uuid4()):  {"name": "Nazlı Koç",   "type": "Misafir",                "seat": "VIP-1","price": "100 TL", "secret": "xxx"},
    str(uuid.uuid4()): {"name": "Tolga Özkan",     "type": "Misafir",                "seat": "D-10", "price": "100 TL", "secret": "xxx"},
    str(uuid.uuid4()): {"name": "Zeynep Aydın",    "type": "Misafir",                "seat": "D-11", "price": "100 TL", "secret": "xxx"},
    str(uuid.uuid4()): {"name": "Can Kaya",             "type": "Misafir",                "seat": "E-01", "price": "100 TL", "secret": "xxx"}
}

def create_frozen_log():
    with open("debug.log", "w", encoding="utf-8") as f:
        for uid, info in tickets_db.items():
            f.write(f"Sahibi: {info['name']} - UUID: {uid}\n")

create_frozen_log()

current_id_counter = 4982
    ...
    <div class="container">
        ...
        {% elif page == 'ticket' %}
            ...
            <div class="ticket">
                ...
                <div class="ticket-right">#{{ ticket.no if ticket.no else '001' }}</div>
            </div>
...
def debug_logs():
    try:
        ...
        return "Log dosyası henüz oluşturulmadı.", 404
