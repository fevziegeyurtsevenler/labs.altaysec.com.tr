...
tickets_db = {
    4920:  {"name": "Admin (root)",       "type": "VIP - ORGANİZATÖR",      "seat": "A-01", "price": "PAHA BİÇİLEMEZ", "secret": "ALTAYSEC{eglenceyi_kacirma}"},
    4925:  {"name": "Ahmet Demir",        "type": "Ekip Lideri", "seat": "A-03", "price": "ÜCRETSİZ (GÖREVLİ)", "secret": "Sunucuların yedeğini almayı unuttum..."},
    4930:  {"name": "Ceren Arslan", "type": "Lider Yardımcısı",       "seat": "A-07", "price": "ÜCRETSİZ (BAŞKAN)", "secret": "Gelecek dönemin etkinlik planı çantamda."},
    4935:  {"name": "Mehmet Yılmaz",   "type": "Lider Yardımcısı",  "seat": "B-01", "price": "ÜCRETSİZ", "secret": "xxx"},
    4940:  {"name": "İrem Çetin",         "type": "Teknik Ekip",      "seat": "B-05", "price": "100 TL", "secret": "xxx"},
    4945:  {"name": "Emre Çelik",    "type": "Adana'","seat": "B-09", "price": "100 TL", "secret": "xxx"},
    4950:  {"name": "Buse Kaya",         "type": "Misafir",                "seat": "C-01", "price": "100 TL", "secret": "xxx"},
    4955:  {"name": "Kerem Kılıç",    "type": "Misafir",                "seat": "C-02", "price": "100 TL", "secret": "xxx"},
    4960:  {"name": "Nazlı Koç",   "type": "Misafir",                "seat": "VIP-1","price": "100 TL", "secret": "xxx"},
    4965: {"name": "Tolga Özkan",     "type": "Misafir",                "seat": "D-10", "price": "100 TL", "secret": "xxx"},
    4970: {"name": "Zeynep Aydın",    "type": "Misafir",                "seat": "D-11", "price": "100 TL", "secret": "xxx"},
    4975: {"name": "Can Kaya",             "type": "Misafir",                "seat": "E-01", "price": "100 TL", "secret": "xxx"}
}

current_id_counter = 4980
...
def buy_ticket():
    ...
    current_id_counter += random.randint(5, 15) 
